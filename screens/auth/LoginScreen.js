...
export default function LoginScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Circular Logo - Positioned between top and login field */}
      ...
      {/* Bottom Section - White Background with Form (55% height) */}
      <View style={styles.bottomSection}>
        <Text style={styles.instructionText}>Insert your phone number to login</Text>
...
const styles = StyleSheet.create({
  ...
  logoImage: {
    ...
    height: '110%',
    right:10,
    borderRadius: (screenWidth * 0.7) / 2 - 8,
  },
  bottomSection: {
    position: 'absolute',
    bottom: 0,
