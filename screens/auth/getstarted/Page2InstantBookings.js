...
export default function Page2InstantBookings({ onSkip, onBack }) {
  return (
    <View style={styles.pageContainer}>
      ...
      >
        ...
        <View style={styles.illustrationContainer}>
          <View style={styles.illustrationCircleBackground}>
            <View style={styles.illustrationCircle}>
              <Image
                source={require('../../../assets/img/getstarted/schedule.jpg')}
        ...
        <View style={styles.textContainer}>
          <Text style={styles.title}>Instant & Future Bookings</Text>
          <Text style={styles.description}>
            Receive instant and future bookings with details of each before accepting.
          </Text>
        </View>
      </LinearGradient>
    </View>
